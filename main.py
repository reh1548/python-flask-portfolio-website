...
def add_new_blog():
    ...
    return render_template("make-blog.html", form=form, current_user=current_user)
...
def blog_single(post_id):
    ...
    if comment_form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("blog-single.html", post=requested_post, current_user=current_user, form=comment_form)
...
def edit_post(post_id):
    ...
    return render_template("make-blog.html", form=edit_form, is_edit=True, current_user=current_user)
